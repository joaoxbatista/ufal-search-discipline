...
- [ ] Juntar os valores dos indices em um array
````javascript
[
    { start: 6, end: 9},
    { start: 17, end: 20},
...
````
- [ ] Dividir o content com base nos limites obtidos
- [ ] Obter os horários de cada range, ou seja, da disciplina (**filterTimeTable**)
